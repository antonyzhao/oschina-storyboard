...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIViewController *viewController = [[UIStoryboard storyboardWithName:@"MainStoryboard" bundle:nil] instantiateInitialViewController];
    
    [MyThread instance].mainView = viewController.view;
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    if([Config instance].isNetworkRunning == NO){
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"警告" message:@"尚未连入网络，将使用离线模式" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
        [alertView show];
    }
}
