...
#define kNotificationTabBarTapClick       @"kNotificationTabBarTapClick"
#define kNotificationLogin                @"kNotificationLogin"
#define kNotificationNoticeUpdate         @"kNotificationNoticeUpdate"
#define kNotificationDetailCommentCount   @"kNotificationDetailCommentCount"

#define curDevice                   [UIDevice currentDevice]
#define userDefaults                [NSUserDefaults standardUserDefaults]

#define ViewControllerFromStoryboard(vcID) [[UIStoryboard storyboardWithName:@"MainStoryboard" bundle:nil] instantiateViewControllerWithIdentifier:vcID]
